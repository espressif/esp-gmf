...
Example:
  ...
  python tools/ci/local_batch_build_apps.py -c tools/ci/local_batch_build_config.esp-gmf.yml

  # List discovered apps without building
  python tools/ci/local_batch_build_apps.py -c tools/ci/local_batch_build_config.esp-gmf.yml --list-apps

  # Same IDF + same board: build apps in parallel (4 processes)
  python tools/ci/local_batch_build_apps.py -c tools/ci/local_batch_build_config.esp-gmf.yml --jobs 4
"""
...
DEFAULT_CONFIG = SCRIPT_DIR / 'local_batch_build_config.esp-gmf.yml'
BMGR_CMD = 'bmgr'
