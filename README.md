...
📖 [Documentation (English)](https://docs.espressif.com/projects/esp-gmf/en/latest/) · [文档 (中文)](https://docs.espressif.com/projects/esp-gmf/zh_CN/latest/)
...
| [esp_board_manager](https://github.com/espressif/esp-board-manager) (external repo) | Intelligent, automated board configuration and management utilities with YAML-based setup | [examples](https://github.com/espressif/esp-board-manager/tree/main/esp_board_manager/examples) | Dependencies vary based on selected board |
