...
{
    return player_seek_wait_decoder_done(stream, seek_done_bits, _CTRL_PLAYER_DECODER_AUDIO_SEEK_DONE,
                                         ESP_PLAYER_ERROR_SOURCE_AUDIO_DECODER, "wait audio seek done failed");
}
