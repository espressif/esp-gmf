...
|:----:| :-----: | :----: | :----: |:----: |:----: |:----: |:----: |:---- |
|  AUDIO_DEC | aud_dec | 音频解码：MP3,AAC,AMRNB,<br>AMRWB,FLAC,WAV,M4A,<br>TS,OPUS,SBC,LC3,<br>ADPCM,ALAC,G711,VORBIS  | 无 |  单个 |  单个  | 可用户配置，默认是最大延迟 |可用户配置，默认是最大延迟 |否 |
|  AUDIO_ENC | aud_enc | 音频编码：AAC,AMRNB,AMRWB,<br>ADPCM,OPUS,PCM,ALAC,<br>SBC,LC3,G711  | 无 |  单个 |  单个  | 可用户配置，默认是最大延迟 |可用户配置，默认是最大延迟 |是 |
